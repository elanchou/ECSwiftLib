...
public extension Color {
    ...
    /// ECSwiftLib: RGB components for a Color (between 0 and 255).
    ///
    ...
    // swiftlint:disable large_tuple
    /// ECSwiftLib: RGB components for a Color represented as CGFloat numbers (between 0 and 1).
    ///
    ...
    // swiftlint:enable large_tuple
    // swiftlint:disable large_tuple
    /// ECSwiftLib: Get components of hue, saturation, and brightness, and alpha (read-only).
    ...
    // swiftlint:enable large_tuple
    /// ECSwiftLib: Hexadecimal value string (read-only).
    ...
    /// ECSwiftLib: Short hexadecimal value string (read-only, if applicable).
    ...
    /// ECSwiftLib: Short hexadecimal value string, or full hexadecimal string if not possible (read-only).
    ...
    /// ECSwiftLib: Alpha of Color (read-only).
    var alpha: CGFloat {
        return cgColor.alpha
    }

    #if !os(watchOS)
    /// ECSwiftLib: CoreImage.CIColor (read-only).
    var coreImageColor: CoreImage.CIColor? {
        return CoreImage.CIColor(color: self)
    }
    #endif

    /// ECSwiftLib: Get UInt representation of a Color (read-only).
    var uInt: UInt {
        let components: [CGFloat] = {
            let comps: [CGFloat] = cgColor.components!
            guard comps.count != 4 else { return comps }
    ...
    /// ECSwiftLib: Get color complementary (read-only, if applicable).
...
// MARK: - Initializers
public extension Color {
    /// ECSwiftLib: Create Color from RGB values with optional transparency.
    ///
    /// - Parameters:
    ///   - red: red component.
    ...
    /// ECSwiftLib: Create Color from hexadecimal value with optional transparency.
    ///
    /// - Parameters:
    ...
    /// ECSwiftLib: Create Color from hexadecimal string with optional transparency (if applicable).
    ///
    /// - Parameters:
    ...
    /// ECSwiftLib: Create Color from a complementary of a Color (if applicable).
    ///
